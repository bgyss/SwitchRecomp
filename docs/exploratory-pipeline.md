...
- The `homebrew-lift` command currently emits a placeholder lifted module with a stub entry function; it does not decode instructions yet.
...
- Replace the placeholder lifter with lifted IR from the pipeline.
